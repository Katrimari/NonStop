...
let tileSize = canvas.width / tileCount -8; // määritetään laatan koko

let headX = 10; //määrittää madon pään paikan horisontaalisesti aloittaessa.
let headY = 10; //-"- vertikaalisesti
const snakeParts = [];
let tailLength = 0; //määrittää hännän pituuden
...
//poistetaan sivun scrollaus nuolinäppäimillä
